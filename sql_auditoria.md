...
[cite_start]Investigação focada em **padrões de acesso** que fogem à política de segurança da empresa[cite: 29, 30].
...
* [cite_start]**Relacionamento de Dados:** Uso de **INNER JOIN** para vincular ativos a usuários[cite: 141, 142].
